...
# BatchGemist versie 1.6
# 
#   Veranderingslogboek:
#     xx-xx-2017 v1.6:
#       - 
#     26-10-2016 v1.51:
#       - Ondersteuning voor Collegerama TU Delft verwijderd i.v.m. copyright van het
#         beeldmateriaal.
#       - NPO extractor: Spaties in video-url van videofragmenten verholpen, waardoor ze nu wel
#         zijn te downloaden / af te spelen. Extra beschikbaarheids controle toegevoegd voor
#         videofragmenten die uiteindelijk toch niet beschikbaar zijn.
#     16-10-2016 v1.5:
#       [Batch code]
#         - Onder :Input waar mogelijk 'GOTO'-commando's onderaan in IF-statement ondergebracht.
#         - :Formats sterk geoptimaliseerd door veel van de speciale queries onderaan bij de
#           desbetreffende extractors onder te brengen.
#         - Onder :Task extra IF-statement toegevoegd voor de twee extractors die Youtube-urls
#           teruggeven. Omdat mijn script het downloaden van Youtube-urls niet ondersteunt, wordt
#           deze vraag in dit geval overgeslagen.
#         - Onder :Task extra IF-statement toegevoegd voor oude 'Silverlight' videostreams, omdat
#           deze geen fragment selectie in de video-url ondersteunen.
#         - Aan :Download de mogelijkheid toegevoegd om ondertiteling van de NPO te muxen.
#         - Onder :Download de FFMpeg-commando '-user_agent', om rtlXL's progressieve videostreams
#           te kunnen downloaden, verwijderd. Voor andere websites gaf dit teveel problemen. Omdat
#           bij rtlXL's progressieve videostreams het nog wel eens gebeurd dat het beeld en geluid
#           niet synchroon lopen, heeft het downloaden van de dynamische videostreams sowieso de
#           voorkeur.
#         - Door betere tekencodering detectie in Xidel 0.9.4. is 'CHCP' overbodig geworden.
#         - Waar nodig extra 'ENDLOCAL'-commando's toegevoegd, omdat in een bepaalde situatie niet
#           alle variabelen waren gereset.
#       [Xidel queries]
#         - Queries geüpdatet in lijn met versie 0.9.4.
#         - ALLE websites opnieuw nagelopen!
#         - Formaat selectie verbeterd: Bij iedere extractor is de volgorde van beschikbare
#           formaten nu eerst progressief en dan dynamisch. En per variant is de kwaliteit
#           oplopend.
#         - Bestandsnaamgeving verbeterd, waardoor aanhalings- en uitroeptekens nu wel goed worden
#           verwerkt in de bestandsnaam.
#         - NPO_meta extractor uitgebreide bestandsnaamgeving gegeven. Hierdoor zijn de
#           naar-NPO_meta-verwijzende-extractors alleen nog verantwoordelijk voor het achterhalen
#           van de programma ID en eventueel de datum.
#         - NPO extractor: Sterk geoptimaliseerd en teruggebracht tot twee queries. Extra
#           beschikbaarheids controles toegevoegd. Alleen de beveiligde progressieve
#           videofragmenten geen nu nog door de resolver. 'Silverlight' videostream controle
#           voorheen onder :Formats nu geïntegreerd.
#         - rtlXL extractor: De bestandsnaamgeving combineert nu de originele datum en niet die
#           van de herhaling. Extra controle toegevoegd voor als de 720p progressieve videostream
#           niet beschikbaar is.
#         - Kijk extractor: Gerepareerd en extra beschikbaarheids controle toegevoegd.
#         - NPO Doc extractor hernoemt naar 2Doc.
#         - Schooltv extractor: Gerepareerd.
#         - NOS extractor: Gerepareerd en ondersteuning toegevoegd voor artikelen met meerdere
#           video's.
#         - EenVandaag extractor: Ondersteuning toegevoegd voor complete uitzendingen.
#         - 101TV extractor: Gerepareerd en ondersteuning toegevoegd voor Youtube-urls.
#         - Alle regionale omroep extractors: Gerepareerd, sterk geoptimaliseerd en bijna allemaal
#           ondersteunen ze nu livestreams, uitzendingen en artikelen al dan niet met meerdere
#           video's.
#         - Telegraaf extractor: Gerepareerd en ondersteuning toegevoegd voor dynamische
#           videostreams.
#         - Nickelodeon: De bestandsnaamgeving combineert nu de originele datum en niet die van de
#           herhaling.
#         - Ketnet extractor: De bestandsnaamgeving combineert nu een datum.
#         - Disney extractor: Gerepareerd en samengevoegd. De bestandsnaamgeving combineert nu een
#           datum. Beschikbaarheids controle voorheen onder :Formats nu geïntegreerd.
#         - Cartoon Network extractor: De bestandsnaamgeving combineert nu een datum.
#           Beschikbaarheids controle voorheen onder :Formats nu geïntegreerd.
#         - Dumpert extractor: Youtube-url controle voorheen onder :Formats nu geïntegreerd.
#         - Comedy Central extractor: Bestandsnaamgeving verbeterd.
#         - Funny Clips extractor: De bestandsnaamgeving combineert nu een datum.
#         - MTV extractor: Bestandsnaamgeving verbeterd.
#         - Tweakers extractor: Gerepareerd, bestandsnaamgeving verbeterd en ondersteuning
#           toegevoegd voor artikelen/reviews met meerdere video's.
#         - Collegerama TU Delft extractor: Ondersteuning toegevoegd voor colleges met meerdere
#           video's.
#         - Ondersteuning toegevoegd voor: Andere Tijden, Willem Wever, NOS Livestreams,
#           101TV Livestream, http://rtl.nl/#!/... en FOX Sports.
#     25-04-2016 v1.41:
#       - Gerepareerd: rtlXL 720p progressieve videostream, niet meer werkende video-url in Disney
#         videoclips extractor en naam video in Disney- en Cartoon Network extractor.
#       - :Download opgeschoond.
#     30-03-2016 v1.4:
#       - Xidel queries geüpdatet in lijn met versie 0.9.1.20160322.
#       - Disney extractor geoptimaliseerd en is nu af. Tijdelijke oplossing aan :Formats
#         toegevoegd voor het downloaden van de progressieve videostreams.
#         LET OP: voor het downloaden van de dynamische videostreams is FFMpeg ná 16 maart nodig!
#       - Ondersteuning toegevoegd voor: Cartoon Network.
#       - Samenvoeging programma-url controle NPO en NPOLive teniet gedaan en een aparte regel
#         voor de livestream van NPO 3 toegevoegd, omdat deze voor problemen bleef zorgen.
#         Hierdoor :NPO_meta en :NPOLive_meta ook geüpdatet.
#       - NOS- en 101TV extractor geoptimaliseerd door beter inzicht in Xidel's mogelijkheden.
#       - NPO extractor geoptimaliseerd en, dankzij een nieuwe versie van Xidel, uitgebreid met
#         een extra beschikbaarheids controle. Ook procenttekens in gecodeerde video-urls worden
#         nu goed weergegeven.
#       - rtlXL extractor gerepareerd: Samenstelling video-url progressieve videostreams. Extra
#         FFMpeg parameter aan :Download toegevoegd voor het kunnen downloaden van de dynamische
#         videostreams.
#       - Kijk extractor uitgebreid met ondersteuning voor progressieve videostreams.
#       - Gerepareerd: Niet meer werkende Tweakers extractor, kleine foutjes in :Formats,
#         :Download en in de AT5 Gemist-, RTV Utrecht Gemist- en RTV Utrecht Nieuws extractor.
#     10-02-2016 v1.3:
#       - Ondersteuning toegevoegd voor: NOS, 101TV, RTL Nieuws, alle regionale omroepen(!) en
#         Disney uitzendingen.
#         LET OP: Ondersteuning voor Disney uitzendingen is nog in ontwikkeling!
#       - Alle andere websites opnieuw nagelopen, sterk geoptimaliseerd, ondersteuning uitgebreid
#         en waar mogelijk bij :Input ondergebracht.
#       - NPO extractor grondig aangepakt waardoor nog meer video's worden ondersteund, waaronder
#         beveiligde progressieve videofragmenten. Op nos.nl, waar ze ook voorkomen, worden ze ook
#         ondersteund.
#       - Programma-url controle van NPO en NPOLive samengevoegd met prid-check, vanwege de
#         livestream van NPO 3, die als enige 'live' niet in de url heeft.
#       - Gerepareerd: Escape characters in video-urls van Collegerama TU Delft.
#       - De :Formats_xxx subroutines teruggebracht tot één grote.
#       - Overzicht ondersteunde websites onder :Help ingekort.
#     15-11-2015 v1.2:
#       - Ondersteuning toegevoegd voor: NPO Doc, Eenvandaag, Telegraaf en Disney videoclips.
#       - Door ondersteuning van Telegraaf, :Formats_json2 aangemaakt en :Tweakers ondergebracht
#         bij :Input.
#       - Door ondersteuning van Eenvandaag, tijdcode-calculaties voor :NPO videofragmenten aan
#         Xidel overgelaten.
#       - NPO extractor opgedeeld in :NPO_meta en :NPO.
#       - Extra FOR-loop toegevoegd voor eventueel achtervoegsel in rtl-embed-url.
#     04-10-2015 v1.1:
#       - Script aanzienlijk verkort door websites en veel voorkomende functies onder te verdelen
#         in aparte subroutines.
#       - Ondersteuning toegevoegd voor: Ketnet en 24Kitchen.
#       - RTVNoord-, RTVDrenthe- en RTVDrenthe_Live extractor vernieuwd.
#     29-09-2015 v1.0:
#       - Eerste versie.
#
# BatchGemist is geschreven door Reino Wijnsma en is terug te vinden op
# http://rwijnsma.home.xs4all.nl/uitzendinggemist/batchgemist.htm.
# Copyright (C) 2017 Reino Wijnsma. Op dit script is de GNU GPLv3 Licentie van toepassing.

# ================================================================================================

:Check
SET xidel="/data/data/com.termux/files/home/xidel"
SET ffmpeg=""
SET mpc=""
...
echo
read /P "id=Voer nummer in van gewenste radiozender: "
IF NOT DEFINED id (
	echo
	ENDLOCAL
	GOTO Input
...
echo
read /P "id=Voer nummer in van gewenst programma: "
IF NOT DEFINED id (
	echo
	ENDLOCAL
	GOTO Input
...
-e ^"let $a:^=read^(^) return
    if ^($a^) then
      if ^('%url%'^='npo'^) then
        ...
        ^)
      else if ^('%url%'^='rtlxl'^) then
        json^(
          concat^(
            'https://search.rtl.nl/?search^='^,
            $a^,
            '^&page^=1^&pageSize^=20^&typeRestriction^=tvabstract'
          ^)
        ^)/^(
          if ^(AvailableResults^='0'^) then
            no_res:^='1'
          else
            s_json:^=[
              ^(Abstracts^)^(^)/{
...
-e ^"if ^($json^('%id%'^)^) then
      p_json:^=if ^('%url%'^='npo'^) then
        ...
        json^(
          concat^(
            'https://xlapi.rtl.nl/version^=1/fun^=progeps/model^=avod/ak^='^,
            $json^(1^)/sid^,
            '/sz^=20/pg^=1'
          ^)
        ^)/[
...
echo
read id=
read /P "id=Voer nummer in van gewenste aflevering: "
IF NOT DEFINED id (
	echo
	ENDLOCAL
	GOTO Input
...
FOR /F "delims=" %%A IN ('echo %p_json% ^| %xidel% -
-e ^"if ^($json^('%id%'^)^) then
      prid:^=$json^(%id%^)/prid
    else
      ^(^)^" --output-format^=cmd^"') DO %%A
...
FOR /F "delims=" %%A IN ('echo %videos% ^| %xidel% - -e "count($json())"') DO (
	IF "%%A"=="1" (
		...
		-e ^"$json^(^)/concat^(^
		    ...
		    ^)^"
		echo
		read /P "video=Kies gewenste video: [1] "
...
IF EXIST %ffmpeg% (
	...
	--xquery ^"formats:^=[
	            ...
	            system^(
	              x'cmd /c %ffmpeg% -i {$x/url} 2^>^&amp^;1'
	            ^) ! {
	              'format':$x/format^,
...
FOR /F "delims=" %%A IN ('echo %formats% ^| %xidel% - -e "count($json())"') DO (
	...
	IF "%%A"=="1" (
		...
		FOR /F "delims=" %%A IN ('echo %formats% ^| %xidel% - -e "$json()[last()]/format"') DO (
			read /P "format=Voer gewenst formaat in: [%%A] "
...
-e ^"let $a:^=[
      {
        'text':'Audio/video-url weergeven.'^,
        'goto':'Render'
      }^,{
        'text':'Audio/video downloaden.'^,
        'goto':'Download'
      }^,{
        'text':'Audio/video openen met MPC-HC/BE.'^,
        'goto':'Play'
      }^,{
        'text':'Audio/video openen met FFmpeg en streamen naar MPC-HC/BE.'^,
        'goto':'PlayXP'
      }
    ] return
    select:^=if ^(
...
echo
SET id=
read /P "id=Voer keuze in: [1] "
IF NOT DEFINED id (
	GOTO Render
) ELSE IF "%id%"=="1" (
	GOTO Render
) ELSE (
	FOR /F "delims=" %%A IN ('echo %select% ^| %xidel% -
	-e ^"if ^($json^('%id%'^)^) then
	      $json^('%id%'^)/goto
	    else
	      'error'^"') DO (
...
IF DEFINED ss (
	...
	echo
	read /P "subs=Inclusief ondertiteling? [j/N] "
	IF /I "!subs!"=="j" (
...
IF /I "%rename%"=="j" (
	...
	-e ^"let $a:^=read^(^) return
	    if ^($a^) then
	      ...
	      '%name%'^" --output-encoding^=oem^"') DO read "name=%%A"
)

SETLOCAL ENABLEDELAYEDEXPANSION
IF DEFINED s_url (
	echo
	read /P "subs=Ondertiteling Downloaden? [j/N] "
	IF /I "!subs!"=="j" (
		echo
		read /P "mux=Ondertiteling Muxen? [j/N] "
